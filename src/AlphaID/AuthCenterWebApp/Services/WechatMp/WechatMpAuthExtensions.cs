...
public static class WechatMpAuthExtensions
{
    ...
    public static AuthenticationBuilder AddWechatMp(this AuthenticationBuilder builder, string authenticationScheme, Action<WechatMpAuthOptions> config)
    {
        return builder.AddOAuth<WechatMpAuthOptions, WechatMpOAuthHandler>(authenticationScheme, "", config);
    }
}
