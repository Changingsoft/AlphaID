...
public static class RealNameBuilderExtensions
{
    ...
    {
        builder.AddRealNameAuthenticationStore<RealNameAuthenticationStore>();
        builder.AddRealNameRequestStore<RealNameRequestStore>();
        return builder;
    }
    ...
    /// <returns></returns>
    public static RealNameBuilder AddDbContext(this RealNameBuilder builder,
