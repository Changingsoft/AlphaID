...
public class RadiusServer(
    ...
    ConnectionRequestHandlerFactory connectionRequestHandlerFactory,
        ...
        while (!cancellationToken.IsCancellationRequested)
        {
            try
            {
                ...
                await Task.Run(async () =>
                {
                    ...
                    //处理连接请求策略
                    var connectionRequestHandler = connectionRequestHandlerFactory.CreateHandler(radiusContext);
