...
public class AdvancedModel : PageModel
{
    ...
    public class InputModel
    {
        ...
        public Duende.IdentityServer.Models.DPoPTokenExpirationValidationMode DPoPValidationMode { get; init; }
        ...
        public string? AllowedIdentityTokenSigningAlgorithms { get; init; }
        ...
        public int RefreshTokenUsage { get; init; } = (int)Duende.IdentityServer.Models.TokenUsage.OneTimeOnly;
        ...
        public int RefreshTokenExpiration { get; init; } = (int)Duende.IdentityServer.Models.TokenExpiration.Absolute;
        ...
        public bool IncludeJwtId { get; init; }
