...
public class TestDatabaseGuardTest(AdminWebAppFactory factory)
{
    [Fact]
    public void HostUsesSelfProvisionedDatabase()
    {
        ...
        OperationalDbContext operational = scope.ServiceProvider.GetRequiredService<OperationalDbContext>();
        Assert.Contains(factory.Database.Name, operational.Database.GetConnectionString()!);
    }
}
